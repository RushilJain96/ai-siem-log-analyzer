...
# SQLite needs check_same_thread=False because FastAPI runs requests
# in a thread pool. Postgres doesn't need this — it has proper
# connection pooling with per-connection concurrency guarantees.
connect_args = (
